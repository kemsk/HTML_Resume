...
def dashboard_view(request):
    # Enforce personnel-only access
    if not require_personnel(request):
    ...
    return render(request, 'guard_system/dashboard.html', {'tickets': page_obj})
...
def add_ticket(request):
    ...
    return render(request, 'guard_system/addViolation.html', {
...
def student_search(request):
    if not require_personnel(request):
        return redirect('ts_users:login') 
    return render(request, 'guard_system/searchStudent.html') 

def statistics_view(request):
    if not require_personnel(request):
        return redirect('ts_users:login') 
    return render(request, 'guard_system/statistics.html') 
...
def ticket_details_view(request, ticket_id):
    ...
    return render(request, 'guard_system/ticket-details.html', {
        'ticket': ticket,
        'student': student,
        'violations': violations,
        'reported_by': name
...
def user_management_view(request):
    ...
    return render(request, 'guard_system/manageUsers.html', context)
